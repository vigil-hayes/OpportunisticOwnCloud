...
/**
 * A database for persistent Local objects
 * @author Athena
 *
 */
public class LocalOpenHelper extends SQLiteOpenHelper {

	private static LocalOpenHelper mInstance = null;
	...
	public static LocalOpenHelper getInstance(Context ctx) {
	      
	    // Use the application context, which will ensure that you 
	    // don't accidentally leak an Activity's context.
	    // See this article for more information: http://bit.ly/6LRzfx
	    if (mInstance == null) {
	      mInstance = new LocalOpenHelper(ctx.getApplicationContext());
	    }
	    return mInstance;
	  }
